...
function myScript(thisObj) {
          function myScript_buildUI(thisObj) {
                    var myPanel = (thisObj instanceof Panel) ? thisObj : new Window("palette", "Ciphering", [0, 0, 220, 200]);
...
var et_myText = pan1_02.add ("edittext", [0,0,200,70], "",{multiline: true});
...
var wordSpaceWidth=25+(trackingWidth*2);
